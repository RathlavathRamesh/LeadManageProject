...
const MembersStatus=()=>{
    return (
      <div className="flex relative flex-col md:flex-row justify-around bg-white  h-auto shadow-xl font-[Poppins]  height-[10rem]  border-solid border-[rem] border-[#F0F0F0]  w-full mt-5 rounded sm:rounded-lg md:rounded-xl p-5">
